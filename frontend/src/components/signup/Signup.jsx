...
function Signup() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen w-full bg-black/80 text-gray-200 px-4">
      <form
      ...
      >
        <h1 className="text-xl sm:text-2xl font-black mb-1">SignUp</h1>
        ...
        <div className="py-2 w-full">
          <Label className="py-1">Fullname</Label>
          <Input
            type="text"
            name="fullname"
